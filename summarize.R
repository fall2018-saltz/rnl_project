...
tapply <- tapply(as.numeric(DayofMonth$Satisfaction), DayofMonth$Day.of.Month, median)
tapply <- tapply(as.numeric(DayofMonth$Satisfaction), DayofMonth$Day.of.Month, sd)
